...
//        int choice = tool.getChoice();
//        while (true) {
//            if (choice == 0) {
//                System.out.println("Exit!");
//                break;
//            } else if (choice == 1) {
//                String plaintext = tool.Plaintext_Input();
//                String key = tool.Key_Input();
//                tool.Encryption_output(plaintext, key);
//                System.out.print(encryption(plaintext, key));
//
//            } else if (choice == 2) {
//
//                String ciphertext = tool.Ciphertext_Input();
//                String key2 = tool.Key_Input();
//                tool.Decryption_output(ciphertext, key2);
//                System.out.print(decryption(ciphertext, key2));
//
//            } else if (choice == 3) {
//
//                String FPlaintext = tool.text_Input_File();
//                String FKey = tool.Key_Input();
//                tool.Encryption_output(FPlaintext, FKey);
//                System.out.print(encryption(FPlaintext, FKey));
//
//            } else if (choice == 4) {
//
//                String FCiphertext = tool.text_Input_File();
//                String FKey2 = tool.Key_Input();
//                tool.Decryption_output(FCiphertext, FKey2);
//                System.out.println(decryption(FCiphertext, FKey2));
//            }
//            System.out.println("\n");
//            choice = tool.getChoice();
//        }
//    }
    ...
    public static String decryption(String ciphertext, String key) {
        ciphertext = ciphertext.toLowerCase();// 将密文转换成大写
