...
public class RSASimple {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int g = (binary.length() + i- 1) / i;
        for(int h=0;h<g;h++){
            System.out.print(textnumber[h]+" ");
        }
        System.out.println();
        ...
        //System.out.println(ciBinary.toString());
        String ciString=ConvertStrTobin(ciBinary.toString());
        System.out.println("加密后："+ciString);
        ...
        String plString=ConvertStrTobin(plBinary.toString());
        System.out.println("解密后："+plString);
